...
function Hero() {
  return (
    <div className='col-span-8 grid grid-cols-8'>
        <div className='col-span-8 relative overflow-x-hidden overflow-y-hidden 
            ...
            <h2 className='text-xl text-center font-semi-bold m-auto mt-[-50px] sm:mt-[-75px] md:mt-[-100px] lg:mt-[-125px]
                text-black w-[300px] md:text-white xl:mt-[-200px] dark:text-white'>
            ...
            <div className='flex flex-col sm:items-center sm:space-x-5 space-y-5
              ...
              >
                <motion.button 
                  ...
                  whileTap={{ scale : .98 }}
                  transition={{ duration : .3, ease : 'easeInOut'}}
                  className='py-3 px-12 dark:border-white hover:text-black
